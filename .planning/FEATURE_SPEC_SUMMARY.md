...
| 14 | Book editor | P1 | M3 | Simple editor escape hatch, not Canva | Pinned wrap in `packages/editor` (D007 — @reyka/openpolotno@1.5.0 exact + single Book→snapshot boundary) + canonical↔snapshot adapter | 11, 12, 13 | ~2 ms drag input-to-paint; byte-stable snapshot round-trip (Spike B) |
