...
- **Required first:** F-002 (theme + `conceptSeed`), F-003 (profile base), F-006 (facts), F-010 (job/queue substrate), `StoryProvider` provider interface agreed (architecture v2).
