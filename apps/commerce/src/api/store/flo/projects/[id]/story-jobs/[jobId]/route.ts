...
export async function PATCH(req: MedusaRequest, res: MedusaResponse) {
  ...
  const body = req.body as { revisionId?: unknown; status?: unknown; teaser?: unknown } | undefined;
  ...
  if (body.status === "READY") await completeStoryJob(db, { ...input, teaser: body.teaser });
